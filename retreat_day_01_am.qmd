...
## 8:30 -- Activity #2 -- Reviewing OEDA Activities

### Purpose

System 1 is not about activities and processes, but about autonomous work units. OEDA does not have defined System 1 units, defaulting instead to individual employees and individual projects.

This activity and the next are designed to see if we can identify new OEDA work units, by identifying groups of activities that individuals routinely do or which their projects routinely require.
...
1.  Open the OEDA actions whiteboard
...
#### Group review and revision (20 minutes)

Ask [clarifying questions](https://www.lucidmeetings.com/glossary/clarifying-question) about any of the cards. Revise cards to fit the constraints below.
...
-   Each card should be a [**transitive verb**](https://www.grammarly.com/blog/parts-of-speech/transitive-verbs/) and a [**direct object**](https://www.grammarly.com/blog/parts-of-speech/direct-object/)
    -   The direct object should relate to the inputs to the activity, not its outputs
    -   You might include a modifier/adjective to add specificity to the object. E.g. rather than include "analyze data," you might find it necessary to distinguish between "analyze survey data", "analyze evaluation data", "analyze interview data", or "analyze economic data."
-   Each card should be **unique**, appearing just once (across the entire whiteboard, your column and those of everyone else)
...
- Mark with a **red flag** any input that the team agrees current has an unknown process, or is difficult, slow, or unreliable to obtain. This highlights known pain points.
...
A more detailed process map of OEDA, highlighting some process dependencies. This will include an early list of starred and flagged inputs which might represent shared resources (and thus potential conflicts) or known bottlenecks. These can be an actionable starting point for designing System 2 later in the retreat.
