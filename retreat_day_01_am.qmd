...
Writing out your hypothetical study was [pre-work](retreat_day_00_prework.qmd) for the retreat. Each OEDA individual contributor will talk for two or three minutes on a hypothetical future OEDA project.

## 8:30 -- Activity #2 -- Reviewing OEDA Actions

### Purpose

In [pre-work](retreat_day_00_prework.qmd) for the retreat, you listed the activities that the OEDA team, currently constituted, can or could engage in to bring value to cross-agency stakeholders. We will review and revise this list together.
...
Ask [clarifying questions](https://www.lucidmeetings.com/glossary/clarifying-question) about any of the sticky-notes. Revise sticky-notes to fit the constraints.

### Constraints

-   Each sticky-note should be a [**transitive verb**](https://www.grammarly.com/blog/parts-of-speech/transitive-verbs/) and a [**direct object**](https://www.grammarly.com/blog/parts-of-speech/direct-object/)
...
A list of activities that OEDA staff or teams of staff can perform independently, are within the [scope of DAS classifications for RA3, ECON3, and ISS7 positions](retreat_support_OEDA_positions.qmd), and which create value for stakeholders.
